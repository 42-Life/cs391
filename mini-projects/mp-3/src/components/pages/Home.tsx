...
import {GreenLink, PageText, PageTitle} from "../ui/StyledText.tsx";
        ...
        <StyledWrapper>
            ...
            <TwoColumnLayout>
                ...
                <NewMain>
                    ...
                    <PageText>My name is Ajani Hickling. I am a sophomore at Boston University, majoring in Computer Science.
                    ...
                    <PageText>The <GreenLink to={'/portfolio'}>Portfolio</GreenLink> page features my artistic work, and
                        the <GreenLink to={'/projects'}>Projects</GreenLink> page features a functioning calculator application.</PageText>
                </NewMain>
            </TwoColumnLayout>
            <Footer/>
        </StyledWrapper>
